...
export default function LoginPage() {
  ...
  async function login() {
    try {
      ...
      // ✅ Direct URL to Auth Service (Backend)
      ...
      // ✅ Token is directly in response.data (not response.data.data)
      ...
      // ✅ Redirect based on role (matching your routes)
      if (user.role === "admin") {
        navigate("/admin");
      ...
      if (err.response) {
        ...
        if (err.response.status === 404) {
          errorMessage =
            "API endpoint not found. Please check if Auth Service is running on port 3008.";
      ...
      <main className="w-full max-w-4xl h-full max-h-150 grid grid-cols-1 md:grid-cols-12 gap-0 overflow-hidden bg-surface-container-low rounded-lg shadow-md relative z-10">
        ...
        <div className="hidden md:flex md:col-span-7 flex-col justify-between p-6 md:p-8 relative overflow-hidden bg-surface-container-highest bg-tertiary">
          <div className="relative z-10">
            ...
            <div className="max-w-sm">
              ...
              <p className="text-sm text-on-surface-variant leading-relaxed opacity-80">
                Designed for clinicians who value precision and serenity.
                Experience a therapeutic digital environment for patient care.
              </p>
            </div>
          </div>
          ...
          <div className="relative z-10 self-end mt-6 w-full max-w-xs p-4 rounded-lg bg-white/40 backdrop-blur-xl border border-outline-variant/20">
            ...
            <p className="text-xs italic text-on-surface-variant">
              "CareBridge has transformed our diagnostic workflow into a calm,
              focused experience."
            </p>
          </div>
        ...
        <div className="md:col-span-5 flex flex-col justify-center p-6 md:p-8 bg-white overflow-y-auto">
          ...
          <div className="flex items-center gap-2 mb-6 md:hidden">
            ...
            <span className="font-headline font-extrabold text-base text-primary tracking-tight">
              CareBridge
            </span>
          </div>
          ...
          <form className="space-y-4" onSubmit={handleSubmit}>
            ...
            <div className="space-y-1.5">
              <label
                className="block text-[10px] font-bold text-on-surface-variant uppercase tracking-wider"
                htmlFor="email"
              >
                Clinical Email
              </label>
            ...
            <div className="space-y-1.5">
              <div className="flex justify-between items-center">
                ...
                <a
                  className="text-[10px] font-bold text-primary hover:text-primary-container transition-colors"
                  href="#forgot"
                >
                  Forgot password?
                </a>
            ...
            <div className="p-3 bg-teal-50 rounded-lg">
              ...
              <p className="text-[9px] text-teal-700">
                👨‍⚕️ Doctor: kamal@doctor.com / 123456
              </p>
              <p className="text-[9px] text-teal-700">
                👤 Patient: nimal@patient.com / 123456
              </p>
              <p className="text-[9px] text-teal-700">
                🛡️ Admin: admin@healthcare.com / admin123
              </p>
            </div>
            ...
            <button
              ...
              disabled={loading}
              style={{
                background: "linear-gradient(135deg, #006063 0%, #007b7f 100%)",
              }}
            >
          ...
          <div className="mt-6 pt-5 border-t border-surface-container text-center">
            <p className="text-[10px] text-on-surface-variant mb-3">
              Secured by CareBridge Encryption Protocol
            </p>
